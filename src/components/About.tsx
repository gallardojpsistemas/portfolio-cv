const About = () => {
  return (
    <section
      id="about"
      className="max-w-6xl mx-auto px-6 text-gray-900 dark:text-gray-100"
    >
      <h2 className="text-4xl font-bold mb-12 text-center">Sobre mí</h2>

      <p className="leading-relaxed text-lg text-center max-w-3xl mx-auto mb-12 text-gray-700 dark:text-gray-300">
